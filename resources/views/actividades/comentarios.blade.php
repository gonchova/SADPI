<x-app-layout>
    ...
    <div class="flex items-center justify-between pb-4">
        ...
        <table class="text-sm text-left text-gray-500 border-solid mx-2 border-collapse  w-full">
            <thead class="text-xs text-gray-700 uppercase bg-indigo-200 sm:text-sm ">
                <tr>
                    ...
                    <th scope="col" class="border px-1 py-2 h-2 text-xs sm:text-sm w-full">
                        Comentario
                    </th>
                    <th scope="col" class="border px-1 py-2 h-2 text-xs sm:text-sm sm:whitespace-nowrap">
                        Fecha
                    </th>
                </tr>
            </thead>
            ...
            <tbody>
               ...
               @foreach ($comentarios as $com)
                    <tr class="bg-white border-b hover:bg-gray-200 text-xs sm:text-sm ">
                        ...
                        <td scope="row" class=" border px-4 py-0 font-medium italic text-black">
