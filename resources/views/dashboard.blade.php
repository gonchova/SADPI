<x-app-layout>
    ...
    <div class="flex-row pt-2 mx-1 sm:mx-4 ">
        <div class="flex-full items-center justify-between pb-1">
            <div class="bg-white shadow-sm sm:rounded-lg pb-2 ">
                <form method="GET" >

                    <div class="flex-full inline-flex flex-wrap px-1 sm:px-4">   

                        <div  class="mx-1 w-40 shrink flex-wrap">
                        ...
                        <div class="flex flex-row flex-initial justify-center mt-2 ">  
                            <div class="flex flex-col flex-initial pb-1 px-1  justify-center ">
                                ...
                                <div class="flex flex-row  w-full justify-center ">
                                    <x-label class="sm:hidden justify-center pb-1 w-full text-xs sm:text-sm ml-10" for="iDesde" :value="__('Desde')" />    
                                    <x-label class="sm:hidden justify-center pb-1 w-full text-xs sm:text-sm ml-10" for="iDesde" :value="__('Hasta')" />    
                                </div> 
                                
                                
                                
                                <div class="flex flex-row w-full flex-initial gap-1 flex-wrap">
                                    <x-label class="hidden sm:flex pt-3 pb-2 pl-1 text-xs sm:text-sm sm:mr-4" for="iDesde" id="lblDesde" :value="__('Desde:')"/>
                                    <x-input class="px-2 h-10 w-30 mr-2" id="iDesde" name="iDesde" type="date" min="" > </x-input>
                
                                    <x-label class="hidden sm:flex pt-3 pb-2 text-xs sm:text-sm " for="iHasta" id="lblHasta" :value="__('Hasta:')"/>
                                    <x-input class="px-2 h-10 w-30" id="iHasta" name="iHasta" type="date" min="" >  </x-input>
                                    
                                    <x-button id="refresh" type="button" class="px-2 h-10 py-2" title="Refrescar grilla">
        ...
        <div id="spinner" class = "flex justify-center mt-0 mb-1" style="visibility:hidden" >
            <svg aria-hidden="true" class="inline w-4 h-4 mr-2 animate-spin text-gray-600 fill-purple-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    response.forEach(item => {
                        ...
                        $('#tablaActividades thead')
                        .append(
                            $('<tr class="visible sm:hidden bg-indigo-200 w-screen sm:w-fit  flex flex-col flex-nowrap whitespace-nowrap sm:table-row rounded-l-lg sm:rounded-none mb-2 sm:mb-0">')
                            .append(
                                $('<th class="p-3 truncate text-left border border-solid sm:w-1/5 ">')
                                .append(
                                    'Actividades'
