                    ...
                    <form method="GET" >
                        ...
                        <div class="flex-full inline-flex flex-wrap px-4">   
                            ...
                            <div  class="mx-2 w-48 shrink flex-wrap">
                                ...
                                <select name="familiasFiltro" id="familiasFiltro" class="text-xs sm:text-sm inline-flex items-center my-1 py-2 px-3 w-full h-auto text-white bg-gray-800 focus:outline-none focus:bg-purple-300 focus:text-black focus:ring-4 focus:ring-gray-200 font-medium rounded-lg border-gray-600  " >
                            ...
                            <div class="flex flex-row flex-initial justify-center mt-2 ">  
                                <div class="flex flex-col flex-initial pb-1 px-1  justify-center ">
                                    ...
                                    <div class="flex flex-row w-full flex-initial gap-1">
                                        <x-label class="hidden sm:flex pt-3 pb-2 pl-1 text-xs sm:text-sm mr-4" for="iDesde" id="lblDesde"/>
                                        <x-input class="px-2 h-10" id="iDesde" name="iDesde" type="date" min="" > </x-input>
                    
                                        <x-label class="hidden sm:flex pt-3 pb-2 text-xs sm:text-sm ml-4 mr-4" for="iHasta" id="lblHasta" />
                                        <x-input class="px-2 h-10" id="iHasta" name="iHasta" type="date" min="" >  </x-input>
                                        
                                        <x-button id="refresh" type="button" class="px-2 mx-2 h-10" title="Refrescar grilla">
                                        ...
                                        <div id="spinner" class = "mt-1" style="visibility:hidden">
